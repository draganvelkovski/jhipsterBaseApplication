...
public class JhipsterBaseApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterBaseApplicationApp.class);

    private final Environment env;

    public JhipsterBaseApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterBaseApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterBaseApplicationApp.class);
